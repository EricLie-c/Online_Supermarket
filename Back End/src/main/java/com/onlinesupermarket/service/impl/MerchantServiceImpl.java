...
public class MerchantServiceImpl implements MerchantService {
    ...
    public void addCommodity(MerchantController.changeCommodityRequest changeCommodityRequest){
        try {
            ...
            String filePath = "http://localhost:8080/images/" + changeCommodityRequest.getFile().getOriginalFilename();
...
//            System.out.println(image.getContentType());
            ...
            changeCommodityRequest.getFile().transferTo(new File("D:/images/"+changeCommodityRequest.getFile().getOriginalFilename()));
