            ...
            <el-form style="text-align: center;">
                <el-form-item label="账 号" label-width=50px>
                    <el-input v-model="signIn.account" autocomplete="off"
                        style="width:370px; text-align-last: center;"></el-input>
                </el-form-item>
                <el-form-item label="密 码" label-width=50px>
                    <el-input v-model="signIn.password" autocomplete="off" style="width:370px; text-align-last: center;"
        ...
        <el-dialog title="注册" :visible.sync="registryVisible" width="30%" style="text-align: center;">
            <el-form>
                <el-form-item label="昵 称" label-width=50px>
                    <el-input v-model="registryForm.userName" autocomplete="off"
                        style="width:370px;text-align-last: center;"></el-input>
                </el-form-item>
                <el-form-item label="密 码" label-width=50px>
                    <el-input v-model="registryForm.password" autocomplete="off"
                        style="width:370px;text-align-last: center;" show-password></el-input>
                </el-form-item>
                <el-form-item label="地 址" label-width=50px>
                    <el-input v-model="registryForm.address" autocomplete="off"
                        style="width:370px;text-align-last: center;"></el-input>
                </el-form-item>
...
export default {
    ...
    methods: {
        ...
        registry: function () {
            axios.post("http://113.44.84.103:8080/registry", this.registryForm).then((result) => {
