...
export default {
    ...
    methods: {
        load() {
            ...
            axios.post("http://localhost:8080/guestView", {
                "page": this.page
            }).then(result => {
        ...
        putDetail(index) {
            ...
            axios.get("http://localhost:8080/guestBrows", {
                params: {
        ...
        addInTrolley(index) {
            ...
            axios.get("http://localhost:8080/addInTrolley", {
                params: {
        ...
        //从数据库获取该用户的购物车
        shopTrolleyDetail() {
            axios.get("http://localhost:8080/shopTrolleyDetail", {
                params: {
        ...
        orderStatusDetail() {
            axios.get("http://localhost:8080/guestOrderStatus", {
                params: {
                    userName: this.userName,
                },
            }).then(
        ...
        deleteRow(index, rows) {
            ...
            axios.get("http://localhost:8080/deleteFromTrolley", {
                params: {
        ...
        queryCommodity() {
            if (this.selectCondition == "pname") {
                axios.post("http://localhost:8080/getCommodity", {
            ...
            //     axios.post("https://apifoxmock.com/m1/5168580-4833413-default/getCommodity", {
