            ...
            <el-container>
                ...
                <el-main style="background-color: #4f7dbd92;">
                    ...
                    <el-form :inline="true" :model="searchForm" size="mini" style="text-align: center;">
                        <el-form-item>
                            <template slot="label"><span style="color: #222;">年份</span></template>
                            <el-input v-model="searchForm.year" placeholder="年份"></el-input>
                        </el-form-item>
                        <el-form-item>
                            <template slot="label"><span style="color: #222;">月份</span></template>
                            <el-input v-model="searchForm.month" placeholder="月份"></el-input>
                        </el-form-item>
                        <el-form-item>
                    ...
                    <el-row :gutter="20">
                        <el-col :span="6">
                            <div>
                                <el-statistic group-separator="," :value="value2" title="总订单量"></el-statistic>
                            </div>
                        </el-col>
                        <el-col :span="6">
                            <div>
...
export default {
    ...
    methods: {
        ...
        handleCurrentChange: function (val) {
            ...
            axios.post("http://localhost:8080/orderManagement", this.searchForm).then(result => {
                this.orderData = result.data.data;
            });
        },
        fileChange(file) {
    ...
    mounted() {
        ...
        this.searchForm['forWhat'] = 'statisticalForm';
        axios.post("http://localhost:8080/orderManagement", this.searchForm).then(result => {
            this.orderData = result.data.data;
        });
        //直接复制粘贴不会补全import axios，要手打
